...
func main() {
	...
	fmt.Println("filterValues(oxygenRatingValues, 0, true)", filterValues(oxygenRatingValues, 0, true))
	fmt.Println("filterValues(co2RatingValues, 0, true)", filterValues(co2RatingValues, 0, false))
